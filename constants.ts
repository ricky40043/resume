...
export const PUBLIC_PROJECTS: Project[] = [
  ...
  {
    id: 105,
    title: "YouTube 下載與升降 Key",
    category: "AI 影音工具",
    section: "領會伴唱",
    status: "Local",
    description: "專為領會練唱設計的 YouTube 工具，支援 YouTube 下載、升降 Key、變速、去人聲與多軌音量控制。",
    highlights: ["YouTube 下載", "升降 Key", "去人聲"],
  ...
  },
  {
    ...
    section: "領會伴唱",
    status: "Planning",
    description: "給領會練唱使用的卡拉 OK 模式，讓使用者播放伴奏、跟唱練習，快速進入適合聚會前預備的狀態。",
    highlights: ["卡拉 OK", "伴奏播放", "跟唱練習"],
